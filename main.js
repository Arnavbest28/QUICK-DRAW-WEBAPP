...
function gotResult(error, results){
    ...
    document.getElementById("confidence").innerHTML="Confidence: "+Math.random(results[0].confidence*0)+'%';
}
...
function check_sketch() {
     timer_counter++;
      document.getElementById('time').innerHTML = 'Timer: ' + timer_counter;
       console.log(timer_counter)
        if(timer_counter > 1600) { timer_counter = 0; timer_check = "completed" }
